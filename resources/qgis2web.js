...
map.getView().fit([13115892.769809, 1054774.446612, 13637847.734145, 1431410.132838], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Land Management Unit Map</h2>';
        return titleElement;
    })(),
